    ...
    return ( 
        ...
        <aside className={openSidebar ? 'hidden':'block'} >
            ...
            <section className='font-sans flex flex-col items-center'>
                ...
                <div className='w-2/3 md:w-[20%] flex flex-col gap-5'>
                    <label htmlFor="email" className="text-gray-700 text-sm font-semibold">Email</label>
                    <input type="text" placeholder='  Enter your Email' className="py-2.5 outline-none border border-gray-300 rounded-lg " ref={inputEmail} />
                ...
                <div className='w-2/3 md:w-[20%] flex flex-col gap-5'>
                    ...
                    <input type="password" placeholder='  Password' className="py-2.5 outline-none border border-gray-300 rounded-lg " ref={inputPassword} />
                ...
                <button className=" font-semibold px-28 py-3 bg-[#3279F3] border border-[#3279F3] text-[#ffffff] rounded-lg" onClick={handleLogin}>Log in</button>
